...
#define ATL_s1U_NU 24

#define ATL_s1L_NU 24
...
{ \
   TYPE *aa=(A_); \
   ATL_CINT lda0_ = 0, lda1_ = lda0_+(lda_), lda2_ = lda1_+(lda_), lda3_ = lda2_+(lda_), lda4_ = lda3_+(lda_), lda5_ = lda4_+(lda_), lda6_ = lda5_+(lda_), lda7_ = lda6_+(lda_), lda8_ = lda7_+(lda_), lda9_ = lda8_+(lda_), lda10_ = lda9_+(lda_), lda11_ = lda10_+(lda_), lda12_ = lda11_+(lda_), lda13_ = lda12_+(lda_), lda14_ = lda13_+(lda_), lda15_ = lda14_+(lda_), lda16_ = lda15_+(lda_), lda17_ = lda16_+(lda_), lda18_ = lda17_+(lda_), lda19_ = lda18_+(lda_), lda20_ = lda19_+(lda_), lda21_ = lda20_+(lda_), lda22_ = lda21_+(lda_), lda23_ = lda22_+(lda_); \
   const TYPE x0_=*(x_), x1_=(x_)[1], x2_=(x_)[2], x3_=(x_)[3], x4_=(x_)[4], x5_=(x_)[5], x6_=(x_)[6], x7_=(x_)[7], x8_=(x_)[8], x9_=(x_)[9], x10_=(x_)[10], x11_=(x_)[11], x12_=(x_)[12], x13_=(x_)[13], x14_=(x_)[14], x15_=(x_)[15], x16_=(x_)[16], x17_=(x_)[17], x18_=(x_)[18], x19_=(x_)[19], x20_=(x_)[20], x21_=(x_)[21], x22_=(x_)[22], x23_=(x_)[23]; \
   const TYPE y0_=*(y_), y1_=(y_)[1], y2_=(y_)[2], y3_=(y_)[3], y4_=(y_)[4], y5_=(y_)[5], y6_=(y_)[6], y7_=(y_)[7], y8_=(y_)[8], y9_=(y_)[9], y10_=(y_)[10], y11_=(y_)[11], y12_=(y_)[12], y13_=(y_)[13], y14_=(y_)[14], y15_=(y_)[15], y16_=(y_)[16], y17_=(y_)[17], y18_=(y_)[18], y19_=(y_)[19], y20_=(y_)[20], y21_=(y_)[21], y22_=(y_)[22], y23_=(y_)[23]; \
   aa[lda0_+0] += x0_*y0_; \
   aa[lda1_+0] += x0_*y1_; \
   aa[lda1_+1] += x1_*y1_; \
   aa[lda2_+0] += x0_*y2_; \
