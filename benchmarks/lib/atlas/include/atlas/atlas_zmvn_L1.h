...
#endif
void ATL_zmvnk__900009(ATL_CINT, ATL_CINT, const double*, ATL_CINT, const double*, double*);
void ATL_zmvnk__900009_b0(ATL_CINT, ATL_CINT, const double*, ATL_CINT, const double*, double*);
      ...
      if ((((((ATL_MulBySize(lda)) >> 4)) << 4)) == ATL_MulBySize(lda))
      {
         if (N >= 5)
         {
            if (M >= 4)
            {
               ...
               *FNU = 1;
               *CacheElts = 7372;
               *mvk_b0 = ATL_zmvnk__900009_b0;
               *DOTBASED = 0;
               return(ATL_zmvnk__900009);
...
#define ATL_GetPartMVN(A_, lda_, mb_, nb_) { *(mb_) = 612; *(nb_) = 5; }
