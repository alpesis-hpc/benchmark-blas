...
#endif
void ATL_zmvtk__900006(ATL_CINT, ATL_CINT, const double*, ATL_CINT, const double*, double*);
void ATL_zmvtk__900006_b0(ATL_CINT, ATL_CINT, const double*, ATL_CINT, const double*, double*);
      ...
      if ((((((ATL_MulBySize(lda)) >> 4)) << 4)) == ATL_MulBySize(lda))
      {
         if (N >= 4)
         {
            if (M >= 8)
            {
               ...
               *FNU = 1;
               *CacheElts = 7700;
               *mvk_b0 = ATL_zmvtk__900006_b0;
               return(ATL_zmvtk__900006);
